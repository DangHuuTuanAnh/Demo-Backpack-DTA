...
<!-- Mirrored from news365htmllatest.bdtask.com/Demo/DemoNews365/home-style-one.html by HTTrack Website Copier/3.x [XR&CO'2014], Wed, 26 Aug 2020 01:14:39 GMT -->
<head>
    <meta charset="utf-8">
    <meta http-equiv="X-UA-Compatible" content="IE=edge">
    <meta name="viewport" content="width=device-width, initial-scale=1">

    <link rel="shortcut icon" href="{{URL::asset('blog/images/fev-icon.png')}}" />

    <title>newspaper</title>

    <link href="https://fonts.googleapis.com/css?family=Lato:100,100i,300,300i,400,400i,700,700i,900,900i|Ubuntu:300,300i,400,400i,500,500i,700,700i" rel="stylesheet">

    <link rel="stylesheet" href="{{URL::asset('blog/css/bootstrap.min.css')}}">

    <link rel="stylesheet" type="text/css" href="{{URL::asset('blog/css/jquery.mCustomScrollbar.css')}}" />

    <link rel="stylesheet" type="text/css" href="{{URL::asset('blog/owl-carousel/owl.carousel.css')}}" />
    <link rel="stylesheet" type="text/css" href="{{URL::asset('blog/owl-carousel/owl.theme.css')}}" />
    <link rel="stylesheet" type="text/css" href="{{URL::asset('blog/owl-carousel/owl.transitions.css')}}" />

    <link rel="stylesheet" type="text/css" href="{{URL::asset('blog/css/RYPP.css')}}" />

    <link rel="stylesheet" href="{{URL::asset('blog/css/jquery-ui.css')}}">

    <link rel="stylesheet" href="{{URL::asset('blog/css/animate.min.css')}}">

    <link rel="stylesheet" href="{{URL::asset('blog/font-awesome//css/font-awesome.min.css')}}">
    <link rel="stylesheet" type="text/css" href="{{URL::asset('blog/css/Pe-icon-7-stroke.css')}}" />
    <link rel="stylesheet" type="text/css" href="{{URL::asset('blog/css/flaticon.css')}}" />

    <link rel="stylesheet" href="{{URL::asset('blog/css/style.css')}}">
</head>
<body>
                ...
                <div class="col-xs-12 col-md-4 col-sm-4">
                    <div class="header-logo">
                        ...
                        <a href="home-style-one.html">
                            <img class="td-retina-data img-responsive" src="{{URL::asset('blog/images/logo.png')}}" alt="">
                        </a>
                    </div>
                </div>
                <div class="col-xs-8 col-md-8 col-sm-8 hidden-xs">
                    <div class="header-banner">
                        <a href="#"><img class="td-retina img-responsive" src="{{URL::asset('blog/images/top-bannner.jpg')}}" alt=""></a>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="row row-margin">
            <div class="col-sm-3 hidden-xs col-padding">
                <div class="post-wrapper wow fadeIn" data-wow-duration="2s">
                    <div class="post-thumb img-zoom-in">
                        <a href="#">
                            <img class="entry-thumb" src="{{URL::asset('blog/images/slider/slide-01.jpg')}}" alt="">
                        </a>
                    </div>
                    <div class="post-info">
                ...
                <div id="news-feed-carousel" class="owl-carousel owl-theme">
                    <div class="item">
                        <div class="post-wrapper wow fadeIn" data-wow-duration="2s">
                            <div class="post-thumb img-zoom-in">
                                <a href="#">
                                    <img class="entry-thumb" src="{{URL::asset('blog/images/slider/slide-02.jpg')}}" alt="">
                                </a>
                            </div>
                            <div class="post-info">
                    ...
                    <div class="item">
                        <div class="post-wrapper wow fadeIn" data-wow-duration="2s">
                            <div class="post-thumb img-zoom-in">
                                <a href="#">
                                    <img class="entry-thumb" src="{{URL::asset('blog/images/slider/slide-03.jpg')}}" alt="">
                                </a>
                            </div>
                            <div class="post-info">
                    ...
                    <div class="item">
                        <div class="post-wrapper wow fadeIn" data-wow-duration="2s">
                            <div class="post-thumb img-zoom-in">
                                <a href="#">
                                    <img class="entry-thumb" src="{{URL::asset('blog/images/slider/slide-04.jpg')}}" alt="">
                                </a>
                            </div>
                            <div class="post-info">
            ...
            <div class="col-sm-3 hidden-xs col-padding">
                <div class="post-wrapper wow fadeIn" data-wow-duration="2s">
                    <div class="post-thumb img-zoom-in">
                        <a href="#">
                            <img class="entry-thumb" src="{{URL::asset('blog/images/slider/slide-05.jpg')}}" alt="">
                        </a>
                    </div>
                    <div class="post-info">
...
<div class="container">
    <div class="row">
        <div class="col-md-8 col-sm-8">
                    ...
                    <div id="content-slide" class="owl-carousel">
                        ...
                        <div class="item">
                            <div class="post-wrapper wow fadeIn" data-wow-duration="1s">
                                ...
                                <div class="post-thumb">
                                    <a href="#">
                                        <img class="img-responsive" src="{{URL::asset('blog/images/recent_news_01.jpg')}}" alt="">
                                    </a>
                                </div>
                        ...
                        <div class="item">
                            <div class="post-wrapper wow fadeIn" data-wow-duration="1s" data-wow-delay="0.2s">
                                ...
                                <div class="post-thumb">
                                    <a href="#">
                                        <img class="img-responsive" src="{{URL::asset('blog/images/recent_news_02.jpg')}}" alt="">
                                    </a>
                                </div>
                                <div class="post-info meta-info-rn">
                                    <div class="slide">
                        ...
                        <div class="item">
                            <div class="post-wrapper wow fadeIn" data-wow-duration="1s" data-wow-delay="0.3s">
                                ...
                                <div class="post-thumb">
                                    <a href="#">
                                        <img class="img-responsive" src="{{URL::asset('blog/images/recent_news_03.jpg')}}" alt="">
                                    </a>
                                </div>
                                <div class="post-info meta-info-rn">
                                    <div class="slide">
                ...
                <div class="row rn_block">
                    <div class="col-md-4 col-sm-6 padd">
                        <div class="post-wrapper wow fadeIn" data-wow-duration="1s">
                            ...
                            <div class="post-thumb">
                                <a href="#">
                                    <img class="img-responsive" src="{{URL::asset('blog/images/recent_news_04.jpg')}}" alt="">
                                </a>
                            </div>
                            <div class="post-info meta-info-rn">
                                <div class="slide">
                    ...
                    <div class="col-md-4 col-sm-6 padd">
                        <div class="post-wrapper wow fadeIn" data-wow-duration="1s" data-wow-delay="0.2s">
                            ...
                            <div class="post-thumb">
                                <a href="#">
                                    <img class="img-responsive" src="{{URL::asset('blog/images/recent_news_05.jpg')}}" alt="">
                                </a>
                            </div>
                            <div class="post-info meta-info-rn">
                                <div class="slide">
                    ...
                    <div class="col-md-4 col-sm-6 hidden-sm padd">
                        <div class="post-wrapper wow fadeIn" data-wow-duration="1s" data-wow-delay="0.3s">
                            ...
                            <div class="post-thumb">
                                <a href="#">
                                    <img class="img-responsive" src="{{URL::asset('blog/images/recent_news_06.jpg')}}" alt="">
                                </a>
                            </div>
                            <div class="post-info meta-info-rn">
                                <div class="slide">
                            ...
                            <div class="row">
                                ...
                                <div class="col-sm-6 col-md-6">
                                    <div class="post-wrapper wow fadeIn" data-wow-duration="2s">
                                        ...
                                        <div class="post-thumb">
                                            <a href="#">
                                                <img src="{{URL::asset('blog/images/politics_01.jpg')}}" class="img-responsive" alt="">
                                            </a>
                                        </div>
                                    </div>
                                    <div class="post-title-author-details">
                                    ...
                                    <div class="row rn_block">
                                        <div class="col-xs-6 col-md-6 col-sm-6 post-padding">
                                            ...
                                            <div class="post-thumb wow fadeIn" data-wow-duration="1s" data-wow-delay="0.1s">
                                                <a href="#">
                                                    <img src="{{URL::asset('blog/images/politics_02.jpg')}}" class="img-responsive" alt="">
                                                </a>
                                            </div>
                                            <div class="post-title-author-details">
                                        ...
                                        <div class="col-xs-6 col-md-6 col-sm-6 post-padding">
                                            ...
                                            <div class="post-thumb wow fadeIn" data-wow-duration="1s" data-wow-delay="0.2s">
                                                <a href="#">
                                                    <img src="{{URL::asset('blog/images/politics_03.jpg')}}" class="img-responsive" alt="">
                                                </a>
                                            </div>
                                            <div class="post-title-author-details">
                                        ...
                                        <div class="col-xs-6 col-md-6 col-sm-6 post-padding">
                                            ...
                                            <div class="post-thumb wow fadeIn" data-wow-duration="1s" data-wow-delay="0.3s">
                                                <a href="#">
                                                    <img src="{{URL::asset('blog/images/politics_04.jpg')}}" class="img-responsive" alt="">
                                                </a>
                                            </div>
                                            <div class="post-title-author-details">
                                        ...
                                        <div class="col-xs-6 col-md-6 col-sm-6 post-padding">
                                            ...
                                            <div class="post-thumb wow fadeIn" data-wow-duration="1s" data-wow-delay="0.4s">
                                                <a href="#">
                                                    <img src="{{URL::asset('blog/images/politics_05.jpg')}}" class="img-responsive" alt="">
                                                </a>
                                            </div>
                                            <div class="post-title-author-details">
            ...
            <div class="ads">
                <a href="#"><img src="{{URL::asset('blog/images/top-bannner2.jpg')}}" class="img-responsive center-block" alt=""></a>
            </div>
        </div>
        ...
        <div class="col-md-4 col-sm-4 left-padding">
            ...
            <div class="banner-add">
                ...
                <a href="#"><img src="{{URL::asset('blog/images/ad-banner.jpg')}}" class="img-responsive center-block" alt=""></a>
            </div>
            <div class="tab-inner">
                <ul class="tabs">
                ...
                <div class="tab_content">
                    <div class="tab-item-inner">
                        <div class="box-item wow fadeIn" data-wow-duration="1s">
                            <div class="img-thumb">
                                <a href="#" rel="bookmark"><img class="entry-thumb" src="{{URL::asset('blog/images/popular_news_01.jpg')}}" alt="" height="80" width="90"></a>
                            </div>
                        ...
                        <div class="box-item wow fadeIn" data-wow-duration="1s" data-wow-delay="0.1s">
                            <div class="img-thumb">
                                <a href="#" rel="bookmark"><img class="entry-thumb" src="{{URL::asset('blog/images/popular_news_02.jpg')}}" alt="" height="80" width="90"></a>
                            </div>
                            <div class="item-details">
                        ...
                        <div class="box-item wow fadeIn" data-wow-duration="1s" data-wow-delay="0.2s">
                            <div class="img-thumb">
                                <a href="#" rel="bookmark"><img class="entry-thumb" src="{{URL::asset('blog/images/popular_news_03.jpg')}}" alt="" height="80" width="90"></a>
                            </div>
                            <div class="item-details">
                        ...
                        <div class="box-item wow fadeIn" data-wow-duration="1s" data-wow-delay="0.3s">
                            <div class="img-thumb">
                                <a href="#" rel="bookmark"><img class="entry-thumb" src="{{URL::asset('blog/images/popular_news_04.jpg')}}" alt="" height="80" width="90"></a>
                            </div>
                            <div class="item-details">
            ...
            <div id="content-slide-4" class="owl-carousel">
                <div class="item">
                    <div class="post-wrapper wow fadeIn" data-wow-duration="1s">
                        <div class="post-thumb img-zoom-in">
                            <a href="#">
                                <img class="entry-thumb" src="{{URL::asset('blog/images/weekly-news-01.jpg')}}" alt="">
                            </a>
                        </div>
                        <div class="post-info">
                            <span class="color-4">FASHION </span>
                ...
                <div class="item">
                    <div class="post-wrapper wow fadeIn" data-wow-duration="1s" data-wow-delay="0.2s">
                        <div class="post-thumb img-zoom-in">
                            <a href="#">
                                <img class="entry-thumb" src="{{URL::asset('blog/images/weekly-news-05.jpg')}}" alt="">
                            </a>
                        </div>
                        <div class="post-info">
                ...
                <div class="item">
                    <div class="post-wrapper wow fadeIn" data-wow-duration="1s" data-wow-delay="0.3s">
                        <div class="post-thumb img-zoom-in">
                            <a href="#">
                                <img class="entry-thumb" src="{{URL::asset('blog/images/weekly-news-02.jpg')}}" alt="">
                            </a>
                        </div>
                        <div class="post-info">
                ...
                <div class="item">
                    <div class="post-wrapper wow fadeIn" data-wow-duration="1s" data-wow-delay="0.4s">
                        <div class="post-thumb img-zoom-in">
                            <a href="#">
                                <img class="entry-thumb" src="{{URL::asset('blog/images/weekly-news-03.jpg')}}" alt="">
                            </a>
                        </div>
                        <div class="post-info">
                ...
                <div class="item">
                    <div class="post-wrapper wow fadeIn" data-wow-duration="1s" data-wow-delay="0.5s">
                        <div class="post-thumb img-zoom-in">
                            <a href="#">
                                <img class="entry-thumb" src="{{URL::asset('blog/images/weekly-news-04.jpg')}}" alt="">
                            </a>
                        </div>
                        <div class="post-info">
                ...
                <div class="item">
                    <div class="post-wrapper wow fadeIn" data-wow-duration="1s" data-wow-delay="0.6s">
                        <div class="post-thumb img-zoom-in">
                            <a href="#">
                                <img class="entry-thumb" src="{{URL::asset('blog/images/weekly-news-06.jpg')}}" alt="">
                            </a>
                        </div>
                        <div class="post-info">
                    ...
                    <div class="col-sm-6 col-md-6">
                        <div class="buisness">
                            ...
                            <div class="post-wrapper wow fadeIn" data-wow-duration="1s">
                                ...
                                <div class="post-thumb">
                                    <a href="#">
                                        <img src="{{URL::asset('blog/images/business-01.jpg')}}" class="img-responsive" alt="">
                                    </a>
                                </div>
                            </div>
                            <div class="post-title-author-details">
                            ...
                            <div class="box-item wow fadeIn" data-wow-duration="1s" data-wow-delay="0.2s">
                                <div class="img-thumb">
                                    <a href="#" rel="bookmark"><img class="entry-thumb" src="{{URL::asset('blog/images/business-02.jpg')}}" alt="" height="70" width="100"></a>
                                </div>
                                <div class="item-details">
                            ...
                            <div class="box-item wow fadeIn" data-wow-duration="1s" data-wow-delay="0.3s">
                                <div class="img-thumb">
                                    <a href="#" rel="bookmark"><img class="entry-thumb" src="{{URL::asset('blog/images/business-03.jpg')}}" alt="" height="70" width="100"></a>
                                </div>
                                <div class="item-details">
                                    <h3 class="td-module-title"><a href="#">Lorem Ipum therefore always free from repetition</a></h3>
                                    <div class="post-editor-date">
                    ...
                    <div class="col-sm-6 col-md-6">
                        <div class="international">
                            ...
                            <div class="post-wrapper wow fadeIn" data-wow-duration="1s">
                                ...
                                <div class="post-thumb">
                                    <a href="#">
                                        <img src="{{URL::asset('blog/images/international.jpg')}}" class="img-responsive" alt="">
                                    </a>
                                </div>
                            </div>
                            <div class="post-title-author-details">
                            ...
                            <div class="box-item wow fadeIn" data-wow-duration="1s" data-wow-delay="0.2s">
                                <div class="img-thumb">
                                    <a href="#" rel="bookmark"><img class="entry-thumb" src="{{URL::asset('blog/images/international-2.jpg')}}" alt="" height="70" width="100"></a>
                                </div>
                                <div class="item-details">
                                    <h3 class="td-module-title"><a href="#">Lorem Ipum therefore always free from repetition</a></h3>
                                    <div class="post-editor-date">
                            ...
                            <div class="box-item wow fadeIn" data-wow-duration="1s" data-wow-delay="0.3s">
                                <div class="img-thumb">
                                    <a href="#" rel="bookmark"><img class="entry-thumb" src="{{URL::asset('blog/images/international-3.jpg')}}" alt="" height="70" width="100"></a>
                                </div>
                                <div class="item-details">
                                    <h3 class="td-module-title"><a href="#">Lorem Ipum therefore always free from repetition</a></h3>
                                    <div class="post-editor-date">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-sm-6 col-md-6">
                                        <div class="post-wrapper wow fadeIn" data-wow-duration="1s">
                                            ...
                                            <div class="post-thumb">
                                                <a href="#">
                                                    <img src="{{URL::asset('blog/images/technology/tecnology-01.jpg')}}" class="img-responsive" alt="">
                                                </a>
                                            </div>
                                        </div>
                                        <div class="post-title-author-details">
                                    ...
                                    <div class="col-sm-6 col-md-6">
                                        <div class="row rn_block">
                                            <div class="col-xs-6 col-md-6 col-sm-6 post-padding">
                                                ...
                                                <div class="post-thumb wow fadeIn" data-wow-duration="1s" data-wow-delay="0.2s">
                                                    <a href="#">
                                                        <img src="{{URL::asset('blog/images/technology/tecnology-02.jpg')}}" class="img-responsive" alt="">
                                                    </a>
                                                </div>
                                                <div class="post-title-author-details">
                                            ...
                                            <div class="col-xs-6 col-md-6 col-sm-6 post-padding">
                                                ...
                                                <div class="post-thumb wow fadeIn" data-wow-duration="1s" data-wow-delay="0.3s">
                                                    <a href="#">
                                                        <img src="{{URL::asset('blog/images/technology/tecnology-03.jpg')}}" class="img-responsive" alt="">
                                                    </a>
                                                </div>
                                                <div class="post-title-author-details">
                                            ...
                                            <div class="col-xs-6 col-md-6 col-sm-6 post-padding">
                                                ...
                                                <div class="post-thumb wow fadeIn" data-wow-duration="1s" data-wow-delay="0.4s">
                                                    <a href="#">
                                                        <img src="{{URL::asset('blog/images/technology/tecnology-04.jpg')}}" class="img-responsive" alt="">
                                                    </a>
                                                </div>
                                                <div class="post-title-author-details">
                                            ...
                                            <div class="col-xs-6 col-md-6 col-sm-6 post-padding">
                                                ...
                                                <div class="post-thumb wow fadeIn" data-wow-duration="1s" data-wow-delay="0.5s">
                                                    <a href="#">
                                                        <img src="{{URL::asset('blog/images/technology/tecnology-05.jpg')}}" class="img-responsive" alt="">
                                                    </a>
                                                </div>
                                                <div class="post-title-author-details">
            ...
            <div class="col-md-4 col-sm-4">
                ...
                <div class="sports-inner">
                    ...
                    <div class="post-wrapper wow fadeIn" data-wow-duration="1s">
                        ...
                        <div class="post-thumb">
                            <a href="#">
                                <img src="{{URL::asset('blog/images/sports.jpg')}}" class="img-responsive" alt="">
                            </a>
                        </div>
                    </div>
                    <div class="post-title-author-details">
            ...
            <div class="col-md-4 col-sm-4">
                ...
                <div class="fashion-inner">
                    ...
                    <div class="post-wrapper wow fadeIn" data-wow-duration="1s">
                        ...
                        <div class="post-thumb">
                            <a href="#">
                                <img src="{{URL::asset('blog/images/fashion.jpg')}}" class="img-responsive" alt="">
                            </a>
                        </div>
                    </div>
                    <div class="post-title-author-details">
            ...
            <div class="col-md-4 col-sm-4">
                ...
                <div class="travel-inner">
                    ...
                    <div class="post-wrapper wow fadeIn" data-wow-duration="1s">
                        ...
                        <div class="post-thumb">
                            <a href="#">
                                <img src="{{URL::asset('blog/images/travel.jpg')}}" class="img-responsive" alt="">
                            </a>
                        </div>
                    </div>
                    <div class="post-title-author-details">
            ...
            <div class="col-md-4 col-sm-4">
                ...
                <div class="food-inner">
                    ...
                    <div class="post-wrapper wow fadeIn" data-wow-duration="1s">
                        ...
                        <div class="post-thumb">
                            <a href="#">
                                <img src="{{URL::asset('blog/images/food.jpg')}}" class="img-responsive" alt="">
                            </a>
                        </div>
                    </div>
                    <div class="post-title-author-details">
            ...
            <div class="col-md-4 col-sm-4">
                ...
                <div class="politics-inner">
                    ...
                    <div class="post-wrapper wow fadeIn" data-wow-duration="1s">
                        ...
                        <div class="post-thumb">
                            <a href="#">
                                <img src="{{URL::asset('blog/images/politics_06.jpg')}}" class="img-responsive" alt="">
                            </a>
                        </div>
                    </div>
                    <div class="post-title-author-details">
            ...
            <div class="col-md-4 col-sm-4">
                ...
                <div class="health-inner">
                    ...
                    <div class="post-wrapper wow fadeIn" data-wow-duration="1s">
                        ...
                        <div class="post-thumb">
                            <a href="#">
                                <img src="{{URL::asset('blog/images/health.jpg')}}" class="img-responsive" alt="">
                            </a>
                        </div>
                    </div>
                    <div class="post-title-author-details">
    ...
    <div class="container">
        <div class="row">
            <div class="col-sm-8">
                ...
                <div class="add_logo">
                    <a href="#"><img src="{{URL::asset('blog/images/top-bannner2.jpg')}}" class="img-responsive" alt=""></a>
                </div>
                                ...
                                <div class="row rn_block">
                                    <div class="col-xs-6 col-md-4 col-sm-4 padd">
                                        <div class="post-wrapper wow fadeIn" data-wow-duration="1s">
                                            ...
                                            <div class="post-thumb">
                                                <a href="#">
                                                    <img class="img-responsive" src="{{URL::asset('blog/images/articale.jpg')}}" alt="">
                                                </a>
                                            </div>
                                            <div class="post-info meta-info-rn">
                                                <div class="slide">
                                    ...
                                    <div class="col-xs-6 col-md-4 col-sm-4 padd">
                                        <div class="post-wrapper wow fadeIn" data-wow-duration="1s" data-wow-delay="0.2s">
                                            ...
                                            <div class="post-thumb">
                                                <a href="#">
                                                    <img class="img-responsive" src="{{URL::asset('blog/images/articale02.jpg')}}" alt="">
                                                </a>
                                            </div>
                                            <div class="post-info meta-info-rn">
                                                <div class="slide">
                                    ...
                                    <div class="col-xs-6 col-md-4 col-sm-4 padd">
                                        <div class="post-wrapper wow fadeIn" data-wow-duration="1s" data-wow-delay="0.3s">
                                            ...
                                            <div class="post-thumb">
                                                <a href="#">
                                                    <img class="img-responsive" src="{{URL::asset('blog/images/articale03.jpg')}}" alt="">
                                                </a>
                                            </div>
                                            <div class="post-info meta-info-rn">
                                                <div class="slide">
                                    ...
                                    <div class="col-xs-6 col-md-4 col-sm-4 padd">
                                        <div class="post-wrapper wow fadeIn" data-wow-duration="1s" data-wow-delay="0.4s">
                                            ...
                                            <div class="post-thumb">
                                                <a href="#">
                                                    <img class="img-responsive" src="{{URL::asset('blog/images/articale04.jpg')}}" alt="">
                                                </a>
                                            </div>
                                            <div class="post-info meta-info-rn">
                                                <div class="slide">
                                    ...
                                    <div class="col-xs-6 col-md-4 col-sm-4 padd">
                                        <div class="post-wrapper wow fadeIn" data-wow-duration="1s" data-wow-delay="0.5s">
                                            ...
                                            <div class="post-thumb">
                                                <a href="#">
                                                    <img class="img-responsive" src="{{URL::asset('blog/images/articale05.jpg')}}" alt="">
                                                </a>
                                            </div>
                                            <div class="post-info meta-info-rn">
                                                <div class="slide">
                                    ...
                                    <div class="col-xs-6 col-md-4 col-sm-4 padd">
                                        <div class="post-wrapper wow fadeIn" data-wow-duration="1s" data-wow-delay="0.6s">
                                            ...
                                            <div class="post-thumb">
                                                <a href="#">
                                                    <img class="img-responsive" src="{{URL::asset('blog/images/articale06.jpg')}}" alt="">
                                                </a>
                                            </div>
                                            <div class="post-info meta-info-rn">
                                                <div class="slide">
                        ...
                        <li>
                            <div>
                                <div class="prettyPhoto">
                                    ...
                                    <a href="#"><img src="{{URL::asset('blog/images/flicker/flicker-01.jpg')}}" class=" popup img-responsive" alt=""></a>
                                </div>
                            </div>
                        </li>
                        <li>
                            <div>
                                <div class="prettyPhoto">
                                    <div class="fp-overlay"><i class="fa fa-mail-forward"></i></div>
                                    <a href="#"><img src="{{URL::asset('blog/images/flicker/flicker-02.jpg')}}" class=" popup img-responsive" alt=""></a>
                                </div>
                            </div>
                        </li>
                        <li>
                            <div>
                                <div class="prettyPhoto">
                                    <div class="fp-overlay"><i class="fa fa-mail-forward"></i></div>
                                    <a href="#"><img src="{{URL::asset('blog/images/flicker/flicker-03.jpg')}}" class=" popup img-responsive" alt=""></a>
                                </div>
                            </div>
                        </li>
                        <li>
                            <div>
                                <div class="prettyPhoto">
                                    <div class="fp-overlay"><i class="fa fa-mail-forward"></i></div>
                                    <a href="#"><img src="{{URL::asset('blog/images/flicker/flicker-04.jpg')}}" class=" popup img-responsive" alt=""></a>
                                </div>
                            </div>
                        </li>
                        <li>
                            <div>
                                <div class="prettyPhoto">
                                    <div class="fp-overlay"><i class="fa fa-mail-forward"></i></div>
                                    <a href="#"><img src="{{URL::asset('blog/images/flicker/flicker-05.jpg')}}" class=" popup img-responsive" alt=""></a>
                                </div>
                            </div>
                        </li>
                        <li>
                            <div>
                                <div class="prettyPhoto">
                                    <div class="fp-overlay"><i class="fa fa-mail-forward"></i></div>
                                    <a href="#"><img src="{{URL::asset('blog/images/flicker/flicker-06.jpg')}}" class=" popup img-responsive" alt=""></a>
                                </div>
                            </div>
                        </li>
                        <li>
                            <div>
                                <div class="prettyPhoto">
                                    <div class="fp-overlay"><i class="fa fa-mail-forward"></i></div>
                                    <a href="#"><img src="{{URL::asset('blog/images/flicker/flicker-07.jpg')}}" class=" popup img-responsive" alt=""></a>
                                </div>
                            </div>
                        </li>
                        <li>
                            <div>
                                <div class="prettyPhoto">
                                    <div class="fp-overlay"><i class="fa fa-mail-forward"></i></div>
                                    <a href="#"><img src="{{URL::asset('blog/images/flicker/flicker-08.jpg')}}" class=" popup img-responsive" alt=""></a>
                                </div>
                            </div>
                        </li>
                        <li>
                            <div>
                                <div class="prettyPhoto">
                                    <div class="fp-overlay"><i class="fa fa-mail-forward"></i></div>
                                    <a href="#"><img src="{{URL::asset('blog/images/flicker/flicker-09.jpg')}}" class=" popup img-responsive" alt=""></a>
                                </div>
                            </div>
                        </li>
                        <li>
                            <div>
                                <div class="prettyPhoto">
                                    <div class="fp-overlay"><i class="fa fa-mail-forward"></i></div>
                                    <a href="#"><img src="{{URL::asset('blog/images/flicker/flicker-10.jpg')}}" class=" popup img-responsive" alt=""></a>
                                </div>
                            </div>
                        </li>
                        <li>
                            <div>
                                <div class="prettyPhoto">
                                    <div class="fp-overlay"><i class="fa fa-mail-forward"></i></div>
                                    <a href="#"><img src="{{URL::asset('blog/images/flicker/flicker-11.jpg')}}" class=" popup img-responsive" alt=""></a>
                                </div>
                            </div>
                        </li>
                        <li>
                            <div>
                                <div class="prettyPhoto">
                                    <div class="fp-overlay"><i class="fa fa-mail-forward"></i></div>
                                    <a href="#"><img src="{{URL::asset('blog/images/flicker/flicker-12.jpg')}}" class=" popup img-responsive" alt=""></a>
                                </div>
                            </div>
                        </li>
                    </ul>
            ...
            <div class="col-sm-4">
                <div class="footer-box">
                    ...
                    <div class="box-item wow fadeIn" data-wow-duration="2s">
                        <div class="img-thumb">
                            <a href="#" rel="bookmark"><img class="entry-thumb" src="{{URL::asset('blog/images/popular_news_01.jpg')}}" alt="" height="80" width="100"></a>
                        </div>
                        <div class="item-details">
                            <h6 class="sub-category-title bg-color-1">
                                <a href="#">SPORTS</a>
                    ...
                    <div class="box-item wow fadeIn" data-wow-duration="2s" data-wow-delay="0.2s">
                        <div class="img-thumb">
                            <a href="#" rel="bookmark"><img class="entry-thumb" src="{{URL::asset('blog/images/popular_news_02.jpg')}}" alt="" height="80" width="100"></a>
                        </div>
                        <div class="item-details">
                            <h6 class="sub-category-title bg-color-2">
                                <a href="#">TECHNOLOGY </a>
                    ...
                    <div class="box-item wow fadeIn" data-wow-duration="2s" data-wow-delay="0.4s">
                        <div class="img-thumb">
                            <a href="#" rel="bookmark"><img class="entry-thumb" src="{{URL::asset('blog/images/popular_news_03.jpg')}}" alt="" height="80" width="100"></a>
                        </div>
                        <div class="item-details">
                            <h6 class="sub-category-title bg-color-3">
                                <a href="#">HEALTH</a>
        ...
        <div class="row">
            <div class="col-sm-3">
                <div class="footer-box footer-logo-address">
                    ...
                    <img src="{{URL::asset('blog/images/footer-logo.png')}}" class="img-responsive" alt="">
                    <address>
                        14L.E Goulburn St, Sydney 2000NSW
                        <br> Tell: 01922296392
                        <br> Email: <a href="https://news365htmllatest.bdtask.com/cdn-cgi/l/email-protection" class="__cf_email__" data-cfemail="5133352530223a11363c30383d7f323e3c">[email&#160;protected]</a>
                    </address>
                </div>
...
<script data-cfasync="false" src="{{URL::asset('blog/cdn-cgi/scripts/5c5dd728/cloudflare-static/email-decode.min.js')}}"></script>
<script type="e31641a6cb0bfba0c1cbb925-text/javascript" src="{{URL::asset('blog/js/jquery.min.js')}}"></script>

<script type="e31641a6cb0bfba0c1cbb925-text/javascript" src="{{URL::asset('blog/js/bootstrap.min.js')}}"></script>

<script type="e31641a6cb0bfba0c1cbb925-text/javascript" src="{{URL::asset('blog/js/metisMenu.min.js')}}"></script>

<script type="e31641a6cb0bfba0c1cbb925-text/javascript" src="{{URL::asset('blog/js/jquery.mCustomScrollbar.concat.min.js')}}"></script>

<script type="e31641a6cb0bfba0c1cbb925-text/javascript" src="{{URL::asset('blog/js/wow.min.js')}}"></script>

<script type="e31641a6cb0bfba0c1cbb925-text/javascript" src="{{URL::asset('blog/js/jquery.newsTicker.js')}}"></script>

<script type="e31641a6cb0bfba0c1cbb925-text/javascript" src="{{URL::asset('blog/js/classie.js')}}"></script>

<script type="e31641a6cb0bfba0c1cbb925-text/javascript" src="{{URL::asset('blog/owl-carousel/owl.carousel.js')}}"></script>

<script type="e31641a6cb0bfba0c1cbb925-text/javascript" src="{{URL::asset('blog/js/RYPP.js')}}"></script>

<script type="e31641a6cb0bfba0c1cbb925-text/javascript" src="{{URL::asset('blog/js/jquery-ui.js')}}"></script>

<script type="e31641a6cb0bfba0c1cbb925-text/javascript" src="{{URL::asset('blog/js/form-classie.js')}}"></script>

<script type="e31641a6cb0bfba0c1cbb925-text/javascript" src="{{URL::asset('blog/js/custom.js')}}"></script>
<script src="{{URL::asset('blog/ajax.cloudflare.com/cdn-cgi/scripts/7089c43e/cloudflare-static/rocket-loader.min.js')}}" data-cf-settings="e31641a6cb0bfba0c1cbb925-|49" defer=""></script></body>

<!-- Mirrored from news365htmllatest.bdtask.com/Demo/DemoNews365/home-style-one.html by HTTrack Website Copier/3.x [XR&CO'2014], Wed, 26 Aug 2020 01:14:57 GMT -->
</html>
